...
window.addEventListener('DOMContentLoaded',()=>{
	...
	chartMetaXHR.open('GET','https://charts-phi.pages.dev/'+play+'/meta.json',true);
	...
	chartMetaXHR.addEventListener('load',()=>{
		...
		chartXHR.open('GET','https://charts-phi.pages.dev/'+play+'/'+chartMetadata['chart'+level.toUpperCase()],true);
		...
		document.body.setAttribute('style','--background: url('+encodeURI('https://charts-phi.pages.dev/'+chartMetadata['codename']+'/'+chartMetadata['illustration'])+')');
		fetch('https://charts-phi.pages.dev/'+chartMetadata['codename']+'/'+chartMetadata['illustration']).then(response => {
		...
		fetch('https://charts-phi.pages.dev/'+chartMetadata['codename']+'/'+chartMetadata['musicFile']).then(response => {
